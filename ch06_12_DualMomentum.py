...
class DualMomentum:
    ...
    def get_rltv_momentum(self, start_date, end_date, stock_count):
        ...
        connection = pymysql.connect(host='localhost', port=3306,
                                     db='INVESTAR', user='root', passwd='bakz6685z!@#', autocommit=True)
...
dm = DualMomentum()
rm = dm.get_rltv_momentum('2019-01-01', '2022-04-20', 300)
am = dm.get_abs_momentum(rm, '2019-01-01', '2022-04-20')